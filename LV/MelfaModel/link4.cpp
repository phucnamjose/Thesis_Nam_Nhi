...
Link4::Link4() :// Class Link4 la con cua class OpenGLWindow (OpenGLWindow la class tu dinh nghia)
    m_indexBuffer(QOpenGLBuffer::IndexBuffer)
  , m_filepath("MelfaModel/models/Part4.STL")
...
void Link4::createShaderProgram(QString vShader, QString fShader)   // do^? bo'ng
{
...
void Link4::setupLightingAndMatrices()
{
...
void Link4::my_paintGL(int w_xRot, int w_yRot, int w_zRot, float w_scale, QMatrix4x4 w_projection, double degJ1, double degJ2, double degJ3)
{
    if(m_error)
        return;
...
void Link4::drawNode(const Node *node, QMatrix4x4 objectMatrix)
{
    // Prepare matrices
...
void Link4::setMaterialUniforms(MaterialInfo &mater)
{
