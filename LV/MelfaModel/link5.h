...
class Link5 /*:public QOpenGLFunctions_3_3_Core, public QOpenGLWidget*/ //
{
public:
    Link5();
    void my_paintGL(int w_xRot, int w_yRot, int w_zRot, float w_scale, QMatrix4x4 w_projection, double degJ1, double degJ2, double degJ3, double degJ4);
