...
Link1::Link1() :// Class Link1 la con cua class OpenGLWindow (OpenGLWindow la class tu dinh nghia)
    m_indexBuffer(QOpenGLBuffer::IndexBuffer)
  , m_filepath("MelfaModel/models/Part1.STL")
...
void Link1::createShaderProgram(QString vShader, QString fShader)   // do^? bo'ng
{
...
void Link1::setupLightingAndMatrices()
{
...
void Link1::my_paintGL(int w_xRot, int w_yRot, int w_zRot, float w_scale, QMatrix4x4 w_projection)
{
    if(m_error)
        return;
...
void Link1::drawNode(const Node *node, QMatrix4x4 objectMatrix)
{
    // Prepare matrices
...
void Link1::setMaterialUniforms(MaterialInfo &mater)
{
