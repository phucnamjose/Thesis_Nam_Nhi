...
Link2::Link2() :// Class link2 la con cua class OpenGLWindow (OpenGLWindow la class tu dinh nghia)
    m_indexBuffer(QOpenGLBuffer::IndexBuffer)
  , m_filepath("MelfaModel/models/Part2.STL")
...
void Link2::createShaderProgram(QString vShader, QString fShader)
{
...
void Link2::setupLightingAndMatrices()
{
...
void Link2::my_paintGL(int w_xRot, int w_yRot, int w_zRot, float w_scale, QMatrix4x4 w_projection, double degJ1)
{
    if(m_error)
        return;
...
void Link2::drawNode(const Node *node, QMatrix4x4 objectMatrix)
{
    // Prepare matrices
...
void Link2::setMaterialUniforms(MaterialInfo &mater)
{
